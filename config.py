...
class Config:
    imgDir = '/media/yunge/HDD1/MOTR/MOTR/datasets/crowdhuman'
    ...
    train_json = osp.join(imgDir, 'annotations', 'crowdhuman_train.json')
    eval_json = osp.join(imgDir, 'annotations', 'crowdhuman_val.json')
    anno_file = osp.join(imgDir, 'odformat', 'crowdhuman_val_hw.odgt')
